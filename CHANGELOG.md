...
- Initial release of TheHashTable
- High-performance hash table implementation inspired by [Verstable](https://github.com/JacksonAllan/Verstable)
- Unified Map/Set API: `TheHashTable(K, V)` for maps, `TheHashTable(K, void)` for sets
...
- Custom hash function support via `TheHashTableWithFns`
